...
/***/ function(module, exports) {
	...
	var Character = function () {
	  function Character(player, color, border, pos) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* globals key */
	...
	var Gameview = function () {
	  ...
	  _createClass(Gameview, [{
	    ...
	    value: function endScreen() {
	      ...
	      var secondPortrait = document.getElementById('secondPortrait');
	      secondPortrait.style.backgroundColor = places[2].color;
	      var thirdPortrait = document.getElementById('thirdPortrait');
	      thirdPortrait.style.backgroundColor = places[1].color;
	      var fourthPortrait = document.getElementById('fourthPortrait');
	      fourthPortrait.style.backgroundColor = places[0].color;
	
	      var firstPlacePlayer = document.getElementById('firstPlacePlayer');
	      firstPlacePlayer.innerHTML = places[3].player;
	      var secondPlacePlayer = document.getElementById('secondPlacePlayer');
	      secondPlacePlayer.innerHTML = places[2].player;
	      var thirdPlacePlayer = document.getElementById('thirdPlacePlayer');
	      thirdPlacePlayer.innerHTML = places[1].player;
	      var fourthPlacePlayer = document.getElementById('fourthPlacePlayer');
