...
class Game {
  ...
  addChars () {
    this.chars.push(new Character("P1", "#00ff99", "#fff", [607, 130]));
    this.chars.push(new Character("P2", "#ff66ff", "#fff", [607, 410]));
    this.chars.push(new Character("P3", "#0099ff", "#fff", [293, 270]));
    this.chars.push(new Character("P4", "#ffff66", "#fff", [923, 270]));
  }
