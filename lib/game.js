...
class Game {
  ...
  addChars () {
    this.chars.push(new Character("Player 1", "#00ff99", "#fff", [607, 130]));
    this.chars.push(new Character("Player 2", "#ff66ff", "#fff", [607, 410]));
    this.chars.push(new Character("Player 3", "#0099ff", "#fff", [293, 270]));
    this.chars.push(new Character("Player 4", "#ffff66", "#fff", [923, 270]));
  }
